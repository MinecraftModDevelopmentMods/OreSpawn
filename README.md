...
This branch builds target-qualified version `4.0.12.2602002`: the OreSpawn 4.0.12
feature set for Minecraft 26.2 and NeoForge.

OreSpawn 4.0.12.2602002 uses NeoGradle 7.1.38 and Gradle 9.2.1. Use exact
...
The audited public outputs are `OreSpawn-4.0.12.2602002.jar`, its sources jar,
