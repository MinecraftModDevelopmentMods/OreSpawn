...
[![Build, test, and audit](https://github.com/MinecraftModDevelopmentMods/OreSpawn/actions/workflows/ci.yml/badge.svg?branch=master-1.18)](https://github.com/MinecraftModDevelopmentMods/OreSpawn/actions/workflows/ci.yml?query=branch%3Amaster-1.18)
...
This branch builds target-qualified version `4.0.13.118021`: the OreSpawn 4.0.13
...
Minecraft 1.18.2; the build rejects a different Java 17 toolchain:
...
ForgeGradle 7.0.34, the Gradle 9.6.1 wrapper, Forge 40.3.0, official Minecraft
1.18.2 mappings, resource pack format 8, and data pack format 9. Ordinary Eclipse launches exclude tests
