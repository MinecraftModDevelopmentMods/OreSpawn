...
[![Build, test, and audit](https://github.com/MinecraftModDevelopmentMods/OreSpawn/actions/workflows/ci.yml/badge.svg?branch=master-1.16.5)](https://github.com/MinecraftModDevelopmentMods/OreSpawn/actions/workflows/ci.yml?query=branch%3Amaster-1.16.5)

# MMD OreSpawn

OreSpawn 4 is a provider-driven world-generation engine for Minecraft 1.16.5.
...
This branch builds target-qualified version `4.0.10.116051`: the OreSpawn 4.0.10
...
ForgeGradle 7.0.34, the Gradle 9.6.1 wrapper, Forge 36.2.34, official Minecraft
1.16.5 mappings, and pack format 6. Ordinary Eclipse launches exclude tests
