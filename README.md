...
This branch builds target-qualified version `4.0.14.2601022`: the OreSpawn 4.0.14
feature set for Minecraft 26.1.2 and NeoForge.

OreSpawn 4.0.14.2601022 uses NeoGradle 7.1.38 and Gradle 9.2.1. Use exact
...
The audited public outputs are `OreSpawn-4.0.14.2601022.jar`, its sources jar,
