...
[![Build, test, and audit](https://github.com/MinecraftModDevelopmentMods/OreSpawn/actions/workflows/ci.yml/badge.svg?branch=master-1.20.6)](https://github.com/MinecraftModDevelopmentMods/OreSpawn/actions/workflows/ci.yml?query=branch%3Amaster-1.20.6)
...
This branch builds target-qualified version `4.0.13.120061`: the OreSpawn 4.0.13
feature set for Minecraft 1.20.6 and Forge. See the
...
Minecraft 1.20.6; the build rejects a different Java 21 toolchain:
...
ForgeGradle 7.0.34, the Gradle 9.6.1 wrapper, Forge 50.2.0, official Minecraft
1.20.6 mappings, and pack format 32. Ordinary Eclipse launches exclude tests
and fixtures. Published jars are deterministic and retain Forge 50's official
