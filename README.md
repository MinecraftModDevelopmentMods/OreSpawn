...
This branch builds target-qualified version `4.0.10.121112`: the OreSpawn 4.0.10
feature set for Minecraft 1.21.11 and NeoForge.

OreSpawn 4.0.10.121112 uses NeoGradle 7.1.38 and Gradle 9.2.1. Use exact
...
The audited public outputs are `OreSpawn-4.0.10.121112.jar`, its sources jar,
