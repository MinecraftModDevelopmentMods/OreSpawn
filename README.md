...
[![Build, test, and audit](https://github.com/MinecraftModDevelopmentMods/OreSpawn/actions/workflows/ci.yml/badge.svg?branch=master-26.1.2)](https://github.com/MinecraftModDevelopmentMods/OreSpawn/actions/workflows/ci.yml?query=branch%3Amaster-26.1.2)

# MMD OreSpawn

OreSpawn 4 is a provider-driven world-generation engine for Minecraft 26.1.2.
...
This branch builds target-qualified version `4.0.14.2601021`: the OreSpawn 4.0.14
feature set for Minecraft 26.1.2 and Forge. See the
...
Run Gradle with Java 25 from the repository root. Install the exact Temurin
`25.0.3+9` toolchain used to compile production code and test fixtures for
Minecraft 26.1.2; the build rejects a different Java 25 toolchain:
...
ForgeGradle 7.0.34, the Gradle 9.6.1 wrapper, Forge 64.0.9, official Minecraft
26.1.2 mappings, and pack format 101.1. Ordinary
Eclipse launches exclude tests and fixtures. Published jars are deterministic and retain Forge 64's official
runtime names, are audited for their four access-transformer rules and contents, and
