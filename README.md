...
[![CI](https://github.com/MinecraftModDevelopmentMods/OreSpawn/actions/workflows/ci.yml/badge.svg?branch=master-1.21.11-neo)](https://github.com/MinecraftModDevelopmentMods/OreSpawn/actions/workflows/ci.yml?query=branch%3Amaster-1.21.11-neo)
...
This branch builds target-qualified version `4.0.11.121112`: the OreSpawn 4.0.11
feature set for Minecraft 1.21.11 and NeoForge.

OreSpawn 4.0.11.121112 uses NeoGradle 7.1.38 and Gradle 9.2.1. Use exact
...
The audited public outputs are `OreSpawn-4.0.11.121112.jar`, its sources jar,
