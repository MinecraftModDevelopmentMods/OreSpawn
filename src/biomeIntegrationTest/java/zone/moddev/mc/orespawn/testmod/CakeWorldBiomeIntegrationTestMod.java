...
public final class CakeWorldBiomeIntegrationTestMod {
	...
	private static final ResourceLocation DIMENSION = new ResourceLocation("minecraft", "the_nether");
	private static final ResourceLocation BIOME = new ResourceLocation(MODID, "cake_plains");
	private static final ResourceLocation PINK_CONCRETE = new ResourceLocation("minecraft", "pink_concrete");
	private static final ResourceLocation WHITE_CONCRETE = new ResourceLocation("minecraft", "white_concrete");
	private static final TagKey<Biome> CAKE_BIOMES = TagKey.create(Registries.BIOME,
			new ResourceLocation(MODID, "cake_biomes"));
	...
	private void enqueueProvider(InterModEnqueueEvent event) {
		...
		WorldgenProvider provider = WorldgenProvider.builder(MODID, 1)
				.biomePalette(new ResourceLocation(MODID, "normal_terrain"), DIMENSION,
						palette -> palette
