...
final class BlockPickerScreen extends OreSpawnScreen {
	...
	private void select(String id) {
		...
		case SEDIMENTARY:
			...
			minecraft.displayGuiScreen(new RockEntryScreen(parent, session, id));
			break;
		case METAMORPHIC:
		...
		case ORES:
			...
			minecraft.displayGuiScreen(new OreEntryScreen(parent, session, id));
			break;
		default:
			minecraft.displayGuiScreen(new BlockAssignmentScreen(parent, session, id));
		}
	}
