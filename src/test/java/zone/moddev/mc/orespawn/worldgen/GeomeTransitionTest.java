...
class GeomeTransitionTest {
	private static final ResourceLocation WINDSWEPT_HILLS = ResourceLocation.parse("minecraft:windswept_hills");
	...
	void explicitBiomeIdentifierWinsOverAliasedBiomeObjectIdentity() {
		...
		ResourceLocation dynamicId = ResourceLocation.fromNamespaceAndPath("cakeworld", "peppermint_pinewoods");
	...
	void identifierFallbackRetainsDictionaryWeightContributions() {
		...
		ResourceLocation marshmallowPeaks = ResourceLocation.fromNamespaceAndPath("cakeworld", "marshmallow_peaks");
		Map<ResourceLocation, double[]> weights = GeomeConfig.bakeBiomeIdentifierWeights(indexes,
