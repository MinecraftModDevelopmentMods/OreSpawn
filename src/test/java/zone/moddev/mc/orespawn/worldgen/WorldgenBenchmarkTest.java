...
class WorldgenBenchmarkTest {
	...
	void leavesGameTestHarnessInControlOfServerShutdown() {
		...
		assertEquals(true, WorldgenBenchmark.allowsFlatBenchmark(GameTestServer.class));
		assertEquals(false, WorldgenBenchmark.allowsFlatBenchmark(MinecraftServer.class));
	}
}
