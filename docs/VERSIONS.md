...
| 1.15.2 | Forge | `115021` | `4.0.8.115021` |
...
Bug number, such as Forge 1.14.4's `4.0.8.114041` and Forge 1.15.2's
`4.0.8.115021`, even though the 4.0.7 repair was not applicable to them.
