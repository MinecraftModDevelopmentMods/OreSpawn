...
Minecraft 1.14.4 exposes one generator fluid, so this branch applies
...
|---|---|---|
| `min_y`, `max_y` | 0-255 in the 1.14.4 editor | Inclusive placement range; the portable schema remains broader for other Minecraft versions |
