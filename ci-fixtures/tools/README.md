...
exact Forge `1.21.11-61.1.0` development dependency and is excluded from every
...
Forge `1.21.11-61.1.0` compiles without source compatibility edits. Its explicit
...
and Minecraft 1.21.11 continue to compile for Java 21.
